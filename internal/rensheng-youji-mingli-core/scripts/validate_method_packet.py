...
def validate(packet: Any, expected_method: str | None = None) -> list[str]:
    ...
    required = {
        ...
        "failure_reasons", "degradation_effects", "input_fact_refs", "source_method_ids_read",
        "technical_conclusions", "reality_hypotheses", "limitations",
    }
    ...
    if status != "complete" and (conclusions or hypotheses or evidence):
        errors.append("未完成方法不得携带半成品结论、候选或证据")
        return errors
