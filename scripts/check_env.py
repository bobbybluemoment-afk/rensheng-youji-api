...
def main() -> int:
    ...
    required = [
        ...
        ROOT / "internal/rensheng-youji-mingli-core/schemas/calibration-probe-patch.schema.json",
        ...
        ROOT / "scripts/prepare_calibration_probes.py",
        ROOT / "scripts/validate_calibration_probe_patch.py",
