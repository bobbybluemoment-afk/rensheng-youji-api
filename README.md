...
报告会把判断落到可以核对的现实层面。事业先分别判断工作方式、组织属性、行业、部门、岗位、处理对象和发展方式，再从公务员、事业单位、国企、民企、外企、专业机构、自由职业、创业等开放候选中选择有证据的少数方向；人力、财务、法务、IT技术、研究、项目、运营、销售等岗位同样不设封闭词库。财富、家庭和伴侣也采用开放候选体系。每个具体名词都有Core交叉证据或用户事实，证据不足时只写到类别边界。
