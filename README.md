...
完整人生主线写成2—3个连贯自然段，综合性格、家庭教育、事业财富、关系方式和当前阶段。六个生活领域分别写成2—4个自然段，覆盖特征、行为方式、形成经历、现实环境、重复挑战、阶段变化和应对，但不把这些要求显示成固定小标题。报告先整理事实，再完成人物初稿，最后经过可追溯中文编辑。PDF正文固定使用仓库内置霞鹜文楷，统一左对齐和字号层级。
...
确定性排盘
  ...
  └→ 五条现实校准 → 事实提纲 → 人物初稿 → 中文编辑 → 同一新版卡片 + 固定10页PDF
```
